    ...
    <main className="flex flex-col gap-10  md:py-10 ">
      <section className="flex flex-col items-center gap-10 justify-center w-full px-5 md:px-0 h-hero-sm  md:h-hero relative">
        <header className="flex flex-col items-center gap-4">
          <h1 className="text-3xl md:text-6xl text-neutral-900  text-center font-medium md:w-10/12">
        ...
        <button
          ...
          className="rounded-md py-3 px-4 w-[230px] font-medium text-white bg-primary"
        >
          Explore events
        </button>
      </section>
